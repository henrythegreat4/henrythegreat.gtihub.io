...
["                                                                                                                                  ",
 ...
 "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"],
  ...
  ["                                                                                                              ",
   ...
   "             xx                       x   x    = = = =x     o      xxx       xxx                              ",
   "             xx                      xx   xx          x                     x!!!x                             ",
   "            xxx               o   o   x   x           x     x                xxv        xxx                   ",
   "           xxx                        x   x           x              x                 x!!!x                  ",
   "           xx                xxx xxx xxx xxx     o o  x!!!!!!!!!!!!!!x                   vx                   ",
   "            xx               x xxx x x xxx x          x!!!!!!!!!!!!!!x                                        ",
   "             xx              x             x   xxxxxxxxxxxxxxxxxxxxxxx                                        ",
   "                             xx           xx                                         xxx                      ",
   "  xxx                         x     x     x                                         x!!!x                xxx  ",
   "  x x                         x    xxx    x                                          xxx                 x x  ",
...
Player.prototype.moveX = function(step, level, keys) {
  ...
  this.speed.x = 0
 if (keys.shift && keys.d) this.speed.x += playerXSuperSpeed;
  if (keys.shift && keys.a) this.speed.x -= playerXSuperSpeed;
...
var arrowCodes = {87: "w", 68: "d", 65: "a", 83: "s", 32: "space", 16: "shift", 37: "left", 38: "up", 39: "right",};
